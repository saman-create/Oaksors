...
export type CrmEndpoint = "qualification-submissions" | "email-submissions" | "retirement-intake-submissions";
...
export type RetirementIntakeSubmission = { firstName: string; lastName: string; dob: string; ssn: string; phone: string; email: string; address: string; married: "married" | "not_married"; portfolioValue: string; accountTypes: string[]; notes?: string; privacyConsent: true };
