...
export type RetirementIntakeSubmission = { firstName: string; lastName: string; dob: string; phone: string; email: string; address: string; married: "married" | "not_married"; portfolioValue: string; accountTypes: string[]; notes?: string; privacyConsent: true };
